    ...
    routes: [
        ...
        },
        {
            ...
            children: [
                {
                    path: '/',
                    component: resolve => require(['../components/platform/home/Index.vue'], resolve)
                },
                {
                    path: '/basetable',
                ...
                {
                    path: '/userinfo',
                    component: resolve => require(['../components/pages/userInfo.vue'], resolve)
                },
                {
                    path: '/searchhistory',
                    component: resolve => require(['../components/pages/searchhistory.vue'], resolve)
                },
                {
                    path: '/test',
